...
Need more detailed installation instructions? [We have them at](./docs/install.md).
...
Calypso welcomes everyone and indeed it has been built by  contributors from all walks of life, with different backgrounds, and with a wide range of experiences. We're committed to doing our part to make both Calypso and the wider WordPress community welcoming to everyone.

You can contribute in many ways. You can help reporting, testing, and detailing bugs, and also test new features we release in our "beta" program for testing on [Horizon](https://horizonfeedback.wordpress.com/).Your contribution would mean a lot to us in more ways than said.
